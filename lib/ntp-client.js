...
exports.formatTemperatureTimestamp = formatTemperatureTimestamp;
exports.getDayOfWeek = getDayOfWeek;
exports.getDayOfWeekFileName = getDayOfWeekFileName;
exports.initTimeSync = initTimeSync;
exports.startPeriodicTimeSync = startPeriodicTimeSync;
 ...
 * 從單個 NTP 伺服器獲取時間
 */
async function fetchTimeFromServer(server) {
 ...
 */
function formatTemperatureTimestamp(date) {
 ...
 * 獲取星期幾的檔案名稱
 */
function getDayOfWeekFileName(date) {
 ...
 * 定期同步時間（每小時同步一次）
 */
function startPeriodicTimeSync(intervalMinutes = 60) {
    setInterval(async () => {
        try {
            await getNTPTime();
        }
 ...
 */
async function getCurrentFormattedTime() {
